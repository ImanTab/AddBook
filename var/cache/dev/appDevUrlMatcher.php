...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // contact_delete
        if (0 === strpos($pathinfo, '/delete') && preg_match('#^/delete/(?P<contactId>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // contact_edit
        if (0 === strpos($pathinfo, '/edit') && preg_match('#^/edit/(?P<contactId>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // contact_show
        if (0 === strpos($pathinfo, '/show') && preg_match('#^/show/(?P<contactId>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // contact_list
        if ($pathinfo === '/list') {
            return array (  '_controller' => 'ContactBundle\\Controller\\ContactController::listAction',  '_route' => 'contact_list',);
        }
